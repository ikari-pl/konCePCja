...
for any personal, hobby, or internal purpose — **including using it as a tool to
create your own works, commercial or not** — but you may not redistribute the
software or publish your own forks/builds of it. See [`LICENSE.md`](LICENSE.md)
for the exact terms and [`NOTICE.md`](NOTICE.md) for the provenance statement and
third-party attributions.

Third-party components are vendored under their own (permissive) licenses in
`vendor/` — see [`vendor/README.md`](vendor/README.md) and
[`NOTICE.md`](NOTICE.md).

The bundled ROM images in `rom/` are &copy; Amstrad plc and Locomotive Software
Ltd, redistributed with permission and **not** covered by the source license
above. Amstrad have kindly given their permission for the redistribution of
their copyrighted material but retain that copyright. See
[`rom/ROM-LICENSE.txt`](rom/ROM-LICENSE.txt) for full details including the
Multiface II ROM.

## Contributing

Contributions are welcome. Because the project is source-available (the license
grants use and modification but not distribution), contributions are accepted
under the terms in [`CONTRIBUTING.md`](CONTRIBUTING.md): open an
issue or submit a PR with a `Signed-off-by` line certifying the
[Developer Certificate of Origin](CONTRIBUTING.md) and granting the project the
right to use your contribution.
