...
class DevToolsUI {
 public:
  ...
  static constexpr int NUM_WINDOWS = 18;
  struct WindowTiming {
    const char* name;
 ...
 private:
  ...
  bool show_drive_sound_lab_ = false;
  ...
  std::atomic<bool> disasm_cache_pending_clear_{
      false};  // set from any thread, drained in render()
