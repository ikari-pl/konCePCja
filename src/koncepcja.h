...
#define CPC_VISIBLE_SCR_WIDTH \
  384  // display width for window sizing: (4+40+4) * 8
#define CPC_RENDER_WIDTH \
  768  // native render width: (4+40+4) * 16 (Mode 2 pixel-accurate)
