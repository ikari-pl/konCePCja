...
// pixels: full surface, vis_x/vis_y/vis_w/vis_h: visible CPC screen region
// within it
void koncpc_update_dock_icon_preview(const void* pixels, int surface_w,
                                     int surface_h, int pitch, int vis_x,
                                     int vis_y, int vis_w, int vis_h);
#else
