...
// NOLINTNEXTLINE(performance-enum-size): enumerators combine with MOD_*
// scancode bits in CPCScancode arithmetic; narrowing the base type breaks key
// decoding.
...
// NOLINTNEXTLINE(performance-enum-size): CPC_KEYS values are OR'd with
// MOD_CPC_* bits to form CPCScancodes; narrowing the base type corrupts that
// arithmetic.
enum CPC_KEYS : std::uint8_t {
#define CPC_AS_ENUM(k) k,
  // NOLINTNEXTLINE(misc-confusable-identifiers): distinct identifiers;
