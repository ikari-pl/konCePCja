...
// Generated by scripts/blob_to_header.py from
// src/shaders/blit.{vert,frag}.glsl. The Linux CI workflow
// (.github/workflows/shader-blobs.yml) compiles the GLSL via glslangValidator
// and auto-commits the populated bytes back to the branch.
#include "blit_spirv_blobs.h"

// ── D3D12: DXBC bytecode ──────────────────────────────────────────────
// Generated by scripts/blob_to_header.py from
// src/shaders/blit.{vert,frag}.hlsl. The Windows CI workflow
// (.github/workflows/shader-blobs.yml) compiles the HLSL via fxc/dxc and
// auto-commits the populated bytes back to the branch, so this header arrives
// populated on D3D12-capable platforms without any developer touching the file
// by hand.
//
