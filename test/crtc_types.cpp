...
TEST_F(CrtcTypesTest, DefaultTypeForCPC464) {
  EXPECT_EQ(0, crtc_type_for_model(0));
}
TEST_F(CrtcTypesTest, DefaultTypeForCPC664) {
  EXPECT_EQ(0, crtc_type_for_model(1));
}
TEST_F(CrtcTypesTest, DefaultTypeForCPC6128) {
  EXPECT_EQ(1, crtc_type_for_model(2));
}
TEST_F(CrtcTypesTest, DefaultTypeForPlus) {
  EXPECT_EQ(3, crtc_type_for_model(3));
}
TEST_F(CrtcTypesTest, DefaultTypeForUnknownModel) {
