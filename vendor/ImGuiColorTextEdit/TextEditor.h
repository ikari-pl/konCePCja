// Vendored dependency: ImGuiColorTextEdit — a colorizing text editor widget
// for Dear ImGui.
// Upstream: https://github.com/santaclose/ImGuiColorTextEdit (a maintained
// fork of the original by BalazsJako: https://github.com/BalazsJako/ImGuiColorTextEdit)
// SPDX-License-Identifier: MIT
// Declared third-party dependency, relocated to vendor/ verbatim — not
// rewritten. konCePCja adds Z80Assembly() in LanguageDefinitions.cpp as a
// downstream language definition, following the file's existing pattern.
#pragma once
...
private:
	...
	// ------------- Types (public for language definitions) ------------- //
public:
	...
	struct LanguageDefinition
	{
		...
		static const LanguageDefinition& Z80Assembly();
	};

	void SetCustomLanguageDefinition(const LanguageDefinition* aDefinition);
